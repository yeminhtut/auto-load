<?php
	$widget_url = "http://tripzilla.sg/widgets/tp_feed_new/japan/3";
	$featured_post_id = 27016;
...
<div id="secondary-content" class="sidebar">
	...
	<div class="sidebar-widget">
		<div class="inner">
			<div id="expert-title"><h4>JAPAN EXPERTS</h4></div>	
			<div class="destination-expert">
				<a href="http://tripzilla.sg/directory/review/653/azza-travel-tours" target="_blank">
					<img src="http://res.cloudinary.com/tzsg/image/upload/q_90,w_75,h_75,c_lpad/tzsg_cd%7C780358.jpg">
				</a>				
			</div>	
			<div class="destination-expert">
				<a href="http://tripzilla.sg/directory/review/18/transtar-travel" target="_blank">
					<img src="http://res.cloudinary.com/tzsg/image/upload/q_90,w_75,h_75,c_lpad/tzsg_cd%7C2430246.jpg">
				</a>				
			</div>	
			<div class="destination-expert">
				<a href="http://tripzilla.sg/directory/review/115/follow-me-japan" target="_blank">
					<img src="http://res.cloudinary.com/tzsg/image/upload/q_90,w_75,h_75,c_lpad/tzsg_cd%7C2284311.jpg">
				</a>				
			</div>
			<div class="cls"></div>
		</div>
