<?php 
	$post_tabs_categories_1 = 'Travel Stories';
	$post_tabs_categories_2 = 'Shopping';
	$post_tabs_categories_3 = 'Trip Planning';
	$post_tabs_title_limiter = 30;
	...
	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_1).'" title="" class="active">Travel Stories</a></li>';
    $warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_2).'" title="">Shopping and eating</a></li>';
	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_3).'" title="">Trip planning</a></li>';
    $warrior_set_content .= '</ul>';
	$warrior_set_content  .= '<div class="tabs_container">';
	$args_posts_tab_1 = array(
		'post_type' 			=> 'post',
		'post_status' 			=> 'publish',
		'category__and' => array(108,102),
