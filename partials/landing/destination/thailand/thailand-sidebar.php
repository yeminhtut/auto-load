<?php
	$widget_url = "http://tripzilla.sg/widgets/tp_feed_new/thailand/3";
	$featured_post_id = 22127;
...
<div id="secondary-content" class="sidebar">
	...
	<div class="sidebar-widget">
		<div class="inner">
			<div id="expert-title"><h4>THAILAND EXPERTS</h4></div>	
			<div class="destination-expert">
				<a href="http://tripzilla.sg/directory/review/101/green-holidays-tours-travel" target="_blank">
					<img src="http://res.cloudinary.com/tzsg/image/upload/q_90,w_75,h_75,c_lpad/tzsg_cd%7C158503.jpg">
				</a>				
			</div>
			<div class="cls"></div>
		</div>
